    ...
    <header class="navbar">
      <div class="container">
        <div class="navbar-brand">
          ...
          <p class="logo--text">Markie <span class="logo-text">AI</span></p>
        ...
        <div id="navbarMenuHeroC" class="navbar-menu">
          <div class="navbar-end">
            ...
            <b-button class="navbar-item get-markie-btn">
              Get Markie
            </b-button>
          </div>
        </div>
    ...
    <div class="container">
      <div class="columns is-vcentered">
        <div class="column is-narrow">
          ...
          <h2 class="subtitle">
            <b-button class="download-btn" type="is-text"> Download for Chrome →</b-button>
          </h2>
        </div>
...
.download-btn:active, .download-btn:hover, .get-markie-btn:active, .get-markie-btn:hover {
