<template>
  <div class="wrapper">
    ...
    <p>
      Markie (“we,” “our,” or “us”) is committed to protecting your privacy.
      This Privacy Policy explains how your personal information is collected,
      used, and disclosed by Markie.
    </p>
    <p>
      This Privacy Policy applies to our website, and its associated subdomains
      (collectively, our “Service”) alongside our application, Markie. By
    ...
    <ul>
      ...
      <li>
        ...
        use the Markie Service to manage the relationships with your consumers
        or service users.
      </li>
      <li>
      ...
      <li>
        Personnel: refers to those individuals who are employed by Markie or are
    ...
    <p>
      Markie will collect End User Data necessary to provide the Markie services
      to our customers.
    </p>
    <p>
    ...
    <p>
      ...
      becoming a Markie customer, we receive information from a third party that
      provides automated fraud detection services to Markie. We also
    ...
    <p>
      Markie will collect personal information that you submit to us. We may
    ...
    <p>
      We keep your information only so long as we need it to provide Markie to
    ...
    <p>
      ...
      information you transmit to Markie or guarantee that your information on
    ...
    <p>
      Markie is incorporated in IN. Information collected via our website,
    ...
    <p>
      ...
      Markie collects depend on your relationship with Markie. Personnel may
    ...
    <p>
      ...
      may take reasonable steps (such as requesting a unique password) to verify
      your identity before granting you profile access or making corrections.
      You are responsible for maintaining the secrecy of your unique password
    ...
    <p>
      ...
      assets of Markie or any of its Corporate Affiliates (as defined herein),
      or that portion of Markie or any of its Corporate Affiliates to which the
    ...
    <p>
      ...
      controls, is controlled by or is under common control with Markie, whether
    ...
    <p>
      The laws of IN, excluding its conflicts of law rules, shall govern this
      Agreement and your use of the website/app. Your use of the website/app may
      also be subject to other local, state, national, or international laws.
    </p>
    <p>
      By using Markie or contacting us directly, you signify your acceptance of
    ...
    <p>
      ...
      using our website/app, registering an account, or making a purchase, you
    ...
    <p>
      ...
      links to other websites not operated or controlled by Markie. We are not
    ...
    <h1>Advertising</h1>
    <p>
      This website/app may contain third party advertisements and links to third
      party sites. Markie does not make any representation as to the accuracy or
      suitability of any of the information contained in those advertisements or
      sites and does not accept any responsibility or liability for the conduct
      or content of those advertisements and sites and the offerings made by the
      third parties.
    </p>
    <p>
      Advertising keeps Markie and many of the websites and services you use
    ...
    <p>
      ...
      services are advertised are not endorsements or recommendations by Markie
      of the third party sites, goods or services. Markie takes no
    ...
    <p>
      These cookies collect information over time about your online activity on
      the website/app and other online services to make online advertisements
      more relevant and effective to you. This is known as interest-based
      advertising. They also perform functions like preventing the same ad from
      continuously reappearing and ensuring that ads are properly displayed for
      advertisers. Without cookies, it’s really hard for an advertiser to reach
      its audience, or to know how many ads were shown and how many clicks they
      received.
    </p>
    <h1>Cookies</h1>
    <p>
    ...
    <p>
      ...
      Help Scout we strongly believe that your data privacy is very important
    ...
    <p>
      ...
      requirements of GDPR. Markie processes or stores all personal data in
