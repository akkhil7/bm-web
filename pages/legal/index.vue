<template>
  <div class="wrapper">
    ...
    <p>Updated at 2020-10-07</p>

    <h1>General Terms</h1>
    <p>
      By accessing and placing an order with Markie, you confirm that you are in
      ...
      email or other type of communication between you and Markie.
    </p>
    <p>
      Under no circumstances shall Markie team be liable for any direct,
      ...
      inability to use, the materials on this site, even if Markie team or an
    ...
    <p>
      Markie will not be responsible for any outcome that may occur during the
    ...
    <h1>License</h1>
    <p>
      Markie grants you a revocable, non-exclusive, non-transferable, limited
      license to download, install and use the website/app strictly in
      accordance with the terms of this Agreement.
    </p>
    <p>
      These Terms & Conditions are a contract between you and Markie (referred
      to in these Terms & Conditions as "Markie", "us", "we" or "our"), the
      provider of the Markie website and the services accessible from the Markie
    ...
    <p>
      ...
      agree to these Terms & Conditions, please do not use the Markie Service.
    ...
    <ul>
      ...
      <li>
        ...
        refers to Markie, that is responsible for your information under this
        Terms & Conditions.
      </li>
      <li>
        Country: where Markie or the owners/founders of Markie are based, in
        this case is IN
      </li>
      <li>
        Device: any internet connected device such as a phone, tablet, computer
        or any other device that can be used to visit Markie and use the
        services.
      </li>
      <li>
        Service: refers to the service provided by Markie as described in the
      ...
      <li>Website: site, which can be accessed via this URL: getmarkie.com</li>
      <li>
        You: a person or entity that is registered with Markie to use the
        Services.
      </li>
    </ul>
    ...
    <ul>
      ...
      <li>
        ...
        copyright or trademark) of Markie or its affiliates, partners, suppliers
        or the licensors of the website/app.
      </li>
    </ul>
    <h1>Return and Refund Policy</h1>
    <p>
      Thanks for shopping at Markie. We appreciate the fact that you like to buy
    ...
    <p>
      ...
      to transactions at Markie. We’ll be as brief as our attorneys will allow.
      The main thing to remember is that by placing an order or making a
      purchase at Markie, you agree to the terms along with Policy.
    </p>
    <p>
    ...
    <p>
      ...
      "Suggestions") provided by you to Markie with respect to the website/app
      shall remain the sole and exclusive property of Markie.
    </p>
    <p>
      Markie shall be free to use, copy, modify, publish, or redistribute the
    ...
    <p>
      ...
      being used. By using our website/app, registering an account, or making a
    ...
    <p>
      ...
      contain links to other websites not operated or controlled by Markie. We
    ...
    <h1>Cookies</h1>
    <p>
      Markie uses "Cookies" to identify the areas of our website that you have
      ...
      performance and functionality of our website/app but are non-essential to
      ...
      details every time you visit the website/app as we would not be able to
    ...
    <p>
      You acknowledge and agree that Markie may stop (permanently or
      temporarily) providing the Service (or any features within the Service) to
      you or to users generally at Markie’s sole discretion, without prior
      notice to you. You may stop using the Service at any time. You do not need
      to specifically inform Markie when you stop using the Service. You
      acknowledge and agree that if Markie disables access to your account, you
    ...
    <p>
      Markie reserves the right to modify, suspend or discontinue, temporarily
      or permanently, the website/app or any service to which it connects, with
      or without notice and without liability to you.
    </p>

    <h1>Updates to Our website/app</h1>
    <p>
      Markie may from time to time provide enhancements or improvements to the
      features/ functionality of the website/app, which may include patches, bug
    ...
    <p>
      ...
      the website/app. You agree that Markie has no obligation to (i) provide
      any Updates, or (ii) continue to provide or enable any particular features
      and/or functionalities of the website/app to you.
    </p>
    <p>
    ...
    <p>
      You acknowledge and agree that Markie shall not be responsible for any
      ...
      aspect thereof. Markie does not assume and shall not have any liability or
    ...
    <p>
      This Agreement shall remain in effect until terminated by you or Markie.
    </p>
    <p>
      Markie may, in its sole discretion, at any time and for any or no reason,
    ...
    <p>
      ...
      Markie, in the event that you fail to comply with any provision of this
    ...
    <p>
      Termination of this Agreement will not limit any of Markie's rights or
    ...
    <p>
      ...
      material on our website/app constitutes an infringement on your copyright,
    ...
    <p>
      You agree to indemnify and hold Markie and its parents, subsidiaries,
      ...
      due to or arising out of your: (a) use of the website/app; (b) violation
    ...
    <h1>No Warranties</h1>
    <p>
      The website/app is provided to you "AS IS" and "AS AVAILABLE" and with all
      faults and defects without warranty of any kind. To the maximum extent
      permitted under applicable law, Markie, on its own behalf and on behalf of
      ...
      statutory or otherwise, with respect to the website/app, including all
      implied warranties of merchantability, fitness for a particular purpose,
      title and non-infringement, and warranties that may arise out of course of
      dealing, course of performance, usage or trade practice. Without
      limitation to the foregoing, Markie provides no warranty or undertaking,
      and makes no representation of any kind that the website/app will meet
    ...
    <p>
      Without limiting the foregoing, neither Markie nor any Markie's provider
      makes any representation or warranty of any kind, express or implied: (i)
      as to the operation or availability of the website/app, or the
      information, content, and materials or products included thereon; (ii)
      that the website/app will be uninterrupted or error-free; (iii) as to the
      accuracy, reliability, or currency of any information or content provided
      through the website/app; or (iv) that the website/app, its servers, the
      content, or e-mails sent from or on behalf of Markie are free of viruses,
    ...
    <p>
      ...
      Markie and any of its suppliers under any provision of this Agreement and
    ...
    <p>
      ...
      Markie or its suppliers be liable for any special, incidental, indirect,
      ...
      website/app, third-party software and/or third-party hardware used with
      the website/app, or otherwise in connection with any provision of this
      Agreement), even if Markie or any supplier has been advised of the
    ...
    <p>
      ...
      notices published by Markie on the Services, shall constitute the entire
      agreement between you and Markie concerning the Services. If any provision
      ...
      further or continuing waiver of such term or any other term, and failure
      to assert any right or provision under this Agreement shall not constitute
      a waiver of such right or provision. YOU AND Markie AGREE THAT ANY CAUSE
    ...
    <p>
      Markie reserves the right, at its sole discretion, to modify or replace
      this Agreement at any time. If a revision is material we will provide at
      least 30 days' notice prior to any new terms taking effect. What
      constitutes a material change will be determined at our sole discretion.
    </p>
    <p>
      By continuing to access or use our website/app after any revisions become
      effective, you agree to be bound by the revised terms. If you do not agree
      to the new terms, you are no longer authorized to use Markie.
    </p>

    <h1>Entire Agreement</h1>
    <p>
      The Agreement constitutes the entire agreement between you and Markie
      regarding your use of the website/app and supersedes all prior and
      contemporaneous written or oral agreements between you and Markie.
    </p>
    <p>
      You may be subject to additional terms and conditions that apply when you
      use or purchase other Markie's services, which Markie will provide to you
    ...
    <p>
      ...
      thereof), are owned by Markie, its licensors or other providers of such
      ...
      written permission of Markie, unless and except as is expressly provided
    ...
    <p>
      ...
      ENFORCEMENT OR VALIDITY OF YOUR OR INTELLECTUAL PROPERTY RIGHTS. The term
      “dispute” means any dispute, action, or other controversy between you and
      Markie concerning the Services or this agreement, whether in contract,
    ...
    <p>
      In the event of a dispute, you or Markie must give the other a Notice of
      ...
      via email to:
      <a href="mailto:support@getmarkie.com"> support@getmarkie.com </a>
      Markie will send any Notice of Dispute to you by mail to your address if
      we have it, or otherwise to your email address. You and Markie will
      attempt to resolve any dispute through informal negotiation within sixty
      (60) days from the date the Notice of Dispute is sent. After sixty (60)
      days, you or Markie may commence arbitration.
    </p>

    <h1>Binding Arbitration</h1>
    <p>
      If you and Markie don’t resolve any dispute by informal negotiation, any
    ...
    <p>
      ...
      become the sole property of Markie without any compensation or credit to
      you whatsoever. Markie and its affiliates shall have no obligations with
    ...
    <h1>Promotions</h1>
    <p>
      Markie may, from time to time, include contests, promotions, sweepstakes,
    ...
    <p>
      ...
      if in writing and signed by an authorized representative of Markie. Markie
      ...
      anticipatory breach by you. Markie operates and controls the Markie
      Service from its offices in IN. The Service is not intended for
      distribution to or use by any person or entity in any jurisdiction or
      country where such distribution or use would be contrary to law or
      regulation. Accordingly, those persons who choose to access the Markie
      ...
      incorporate the Markie Privacy Policy) contains the entire understanding,
      and supersedes all prior understandings, between you and Markie concerning
    ...
    <h1>Disclaimer</h1>
    <p>
      Markie is not responsible for any content, code or any other imprecision.
    </p>
    <p>Markie does not provide warranties or guarantees.</p>
    <p>
      In no event shall Markie be liable for any special, direct, indirect,
    ...
    <p>
      The Markie Service and its contents are provided "as is" and "as
      available" without any warranty or representations of any kind, whether
      express or implied. Markie is a distributor and not a publisher of the
      content supplied by third parties; as such, Markie exercises no editorial
      ...
      or merchandise provided through or accessible via the Markie Service.
      Without limiting the foregoing, Markie specifically disclaims all
      warranties and representations in any content transmitted on or in
      connection with the Markie Service or on sites that may appear as links on
      the Markie Service, or in the products provided as a part of, or otherwise
      in connection with, the Markie Service, including without limitation any
      warranties of merchantability, fitness for a particular purpose or
      non-infringement of third party rights. No oral advice or written
      information given by Markie or any of its affiliates, employees, officers,
      ...
      limiting the foregoing, Markie does not warrant that the Markie Service
      will be uninterrupted, uncorrupted, timely, or error-free.
    </p>

    <h1>Contact Us</h1>
    <p>
      <a href="mailto:support@getmarkie.com"
        >Don't hesitate to contact us if you have any questions.</a
      >
    </p>
  </div>
</template>
